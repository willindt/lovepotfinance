      ...
      >
        <Flex flex="1" flexDirection="column">
          ...
          <Text mb="20px" fontSize="20px">
            {t('Make good earning crypto safely and securely on our decentralized finance platform by Staking in Pool, Farm and Jackpot')}
          </Text>
          <Text mb="20px" fontSize="20px">
            {t('Toal Value Locked')}
          </Text>
          ...
          <Flex>
            ...
            <Link mr="16px" href="https://lovepot.finance/swap">
